...
<body>
    <section class="header">
        ...
        <div class="text-box">
            ...
            <p>Welcome to our School WebSite<br>Here you can ensure your children's bright future and joyful growth</p><br><br>
    ...
    <section class="course">
        ...
        <div class="row">
            <div class="course-col">
                <h2>Science</h2>
                <p class="pag">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
            </div>
            <div class="course-col">
                <h2>Arts</h2>
                <p class="pag">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
...
<!------------------Campus ----------->  
    ...
    <section class="facilities">
        ...
        <marquee><p>There are many facilities you can found in our School</p></marquee>
        <div class="row">
            <div class="faci-col">
