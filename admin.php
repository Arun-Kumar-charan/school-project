...
<!------------LogIn page-------------->
        <div class="form-box">
            <div class="form-value">
                <form  action="adminLogin_backend.php" method="post" enctype="multipart/form-data">
                    <h1>Admin LogIn</h1>
                    <div class="inputbox">
                    ...
                    <div class="register">
                        <p style="color: white;">Don't have a account? <a href="forgot.php"><span>Register Here</span></a></p>
                    </div>
                </form>
                </form>
            </div>
